...
public class App {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            CoffeeMachine4 coffeeMachine4 = new CoffeeMachine4("Модель-4",200,200,200,0,150);
            CoffeeMachine5 coffeeMachine5 = new CoffeeMachine5("Модель-5",250,250,250,0,200);
            CoffeeMachine6 coffeeMachine6 = new CoffeeMachine6("Модель-6",250,0,250,250,0,200);
            CoffeeMachine7 coffeeMachine7 = new CoffeeMachine7("Модель-7",300 , 0 ,300,300,0,250);
            ...
            switch (scanner.nextInt()) {
                case 1:
                    ...
                    coffeeMachine6.List6();
                    coffeeMachine7.List7();
                    ...
                    switch (scanner.nextInt()) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            coffeeMachine6.workForMachine();
                            break;
                        case 7:
                            coffeeMachine7.workForMachine();
                            break;
                    }
                    break;
                case 2:
