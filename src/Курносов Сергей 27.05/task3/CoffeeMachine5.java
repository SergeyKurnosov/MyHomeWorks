...
public class CoffeeMachine5 extends AbstractPattern {

    public CoffeeMachine5(String name, int containerForCoffee, int containerForWater, int containerForMilk, int containerForWastes, int containerForWastesUp) {
