...
public class CoffeeMachine7 extends AbstractPattern {

    public CoffeeMachine7(String name, int containerForCoffeeCorn, int containerForCoffee, int containerForWater, int containerForMilk, int containerForWastes, int containerForWastesUp) {
